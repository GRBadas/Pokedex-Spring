...
import org.springframework.beans.factory.annotation.Value;
	...
	@Service
	public class StudyNotesGPTService {
		private WebClient webClient;
		
		public StudyNotesGPTService(WebClient.Builder builder, 
		...
		private ChatGPTRequest createStudyRequest(String topic) {
			String question = "Quais são os pontos chave que devo estudar sobre o seguinte assunto : " + 
		topic;
